...
Gets all devices returned by the iCOMM API, including devices that are not yet recognized by this library.
This is useful for debugging support for newly discovered models.
